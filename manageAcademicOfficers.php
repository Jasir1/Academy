...
<body class="my_background1">
    ...
    ?>
        ...
        <nav class="navbar navbar-expand d-flex flex-column align-item-start shadow" id="sidebar">
            ...
            <script>
                var btn = document.getElementById('manageAcademicOfficers'); btn.style.backgroundColor = 'rgba(122, 118, 118, 0.5)';
            </script>
        ...
        <section class="p-4 my-container nav-body">
            ...
            <div class="row m-2 my_div">
                <div class="col-12 pt-4">
                    <h2 class="text-center text-white">Manage Academic Officers</h2>
                </div>
                    ...
                    <div class="row mt-3 g-3 justify-content-center">
                                ...
                                <div class="col-12 col-md-8 col-lg-6 m-auto mt-5">
                                    <div class="row">
                                        <div class="input-group mb-3">
                                            <input type="text" placeholder="Search academic officer here..." class="form-control" aria-label="Text input with dropdown button" id="academic_officer_search">
                                ...
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            ...
                                            $ActiveUserrs = Database::search("SELECT COUNT(`status_id`) AS `count` FROM `academic_officer` WHERE `status_id`='1'");
                                            $ActiveUser = $ActiveUserrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Active Academic Officers :</span>
                                            <span class="text-white fs-4"> <?php echo $ActiveUser["count"]; ?> </span>
                                        </div>
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            <?php

                                            $InactiveUserrs = Database::search("SELECT COUNT(`status_id`) AS `count` FROM `academic_officer` WHERE `status_id`='2'");
                                            $InactiveUser = $InactiveUserrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Inactive Academic Officers :</span>
                        ...
                        <div class="col-12 mt-3 mb-3 my_div1">
                            <div class="row justify-content-center">
                                ...
                                $user_rs = Database::search("SELECT * FROM `academic_officer`");
                                ...
                                $view_user_rs = Database::search("SELECT * FROM `academic_officer` LIMIT " . $results_per_page . " OFFSET " . $page_first_result . " ");
                                ...
                                ?>
                                    ...
                                    <div class="col-12 px-5 mt-2">
                                        <div class="row">
                                            ...
                                            $image_rs = Database::search("SELECT * FROM `academic_officer_profile_img` WHERE `user_email`='" . $user_data["email"] . "'");
                                            ...
                                            <div class="col-3 my_div border border-end rounded-3 py-2 d-none d-lg-block">
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 d-grid">
                                                        ...
                                                        if ($s == "1") {
                                                        ?>
                                                            <button class="btn btn-danger" onclick="academicOfficerBlock('<?php echo $user_data['email']; ?>');">Block</button>
                                                        <?php
                                                        } else {
                                                        ?>
                                                            <button class="btn btn-success" onclick="academicOfficerBlock('<?php echo $user_data['email']; ?>');">Unblock</button>
                                                        <?php
                                                        }
                    ...
                    <div class="row mb-3 g-3 justify-content-center">
                        <div class="col-12 my_div1">
                            ...
                            <div class="row my-3">
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <button class="col-5 mx-auto py-2 btn-primary rounded rounded-3 text-center" onclick="addAcademicOfficerWindow();">
                                            <span class="text-white fw-bold fs-4 bi bi-person-plus-fill"></span>
                                            <span class="text-white fw-bold fs-4">Add Academic Officers</span>
                                        </button>
                ...
                <!-- add Academic Officer modal -->
                <div class="modal" tabindex="-1" id="addAcademicOfficerModal">
                    <div class="modal-dialog">
                        <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                            ...
                            <div class="modal-body text-center">
                                <div class="col-12">
                                    <h5 class="modal-title fs-5 fw-bold">Add Academic Officer</h5>
                                ...
                                <div class="col-12 gy-3">
                                    ...
                                    <div class="col-7 mt-3 mx-auto">
                                        <button class="col-12 btn-orange" onclick="addNewAcademicOfficer();">Add Academic Officer & Send verification</button>
                                    </div>
                                </div>
            ...
            <!-- success -->
            <div class="modal" tabindex="-1" id="newAcademicOfficerAccountCreatedModal">
                <div class="modal-dialog">
                    <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                        <div class="modal-header border-0">
                            <h5 class="modal-title fs-5 fw-bold">Success</h5>
                            <a href="manageAcademicOfficers.php" class="btn-close"></a>
                        </div>
                        <div class="modal-body text-center">
                            <label class="success_message" style="height: 60px;"></label>
                            <br />
                            <label class="form-label fs-6">New academic officer account created successfully.</label>
                        </div>
                        <div class="modal-footer border-0">
                            <a href="manageAcademicOfficers.php" class="btn btn-secondary">Ok</a>
                        </div>
                    </div>
                </div>
            </div>
