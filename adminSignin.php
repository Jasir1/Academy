                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-7 col-md-5 col-lg-4 mx-auto box1" id="signInBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12">
                                <input class="inputbox1" type="email" placeholder="Email" id="email" value="<?php echo $email; ?>" />
                            </div>
            ...
            <div class="modal" tabindex="-1" id="forgotPasswordModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <label class="fa fa-check fs-1 mt-5" style="color: #27ae60; border: 2px solid #27ae60; border-radius: 50%; box-sizing: border-box; padding: 10px;"></label>
                            <br />
