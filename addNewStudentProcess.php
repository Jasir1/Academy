...
if (empty($username)) {
    ...
    $r = Database::search("SELECT * FROM `student` WHERE `email`='".$email."' OR `mobile`='".$mobile."' OR `username`='".$username."' ");
    $n = $r->num_rows;
    ...
    if ($n > 0){
        ...
        Database::iud("INSERT INTO `student` (`email`,`username`,`password`,`mobile`,`gender_id`,`register_date`)
