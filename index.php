        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="text-center title1">Hi, Welcome to Academy</p>
                    </div>
                </div>
            </div>
            <!-- header -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-7 col-md-5 col-lg-4 mx-auto box1" id="signInBox">
                        <div class="row g-2">
                            ...
                            <div class="col-12">
                                <label class="form-check-label title2 fs-5">Log In as</label>
                            </div>

                            <div class="col-12" id="acc_type">
                                <input type="radio" class="form-check-label title2 fs-5 text-white" name="acc_type" id="teacher" value="teacher">&nbsp;Teacher</label><br/>
                                <input type="radio" class="form-check-label title2 fs-5 text-white" name="acc_type" id="student" value="student">&nbsp;Student</label><br/>
                                <input type="radio" class="form-check-label title2 fs-5 text-white" name="acc_type" id="academic_officer" value="academic_officer">&nbsp;Academic Officer</label>
                            </div>
