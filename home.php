...
<body class="my_background1">
    ...
    <section class="p-4 my-containe nav-body">
        ...
        <div class="row m-2 my_div">
            <div class="col-11 mt-5 mx-auto my-5">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12 col-lg-10 offset-lg-1 mt-4">
                                <div class="input-group mb-3">
                                    <input type="text" placeholder="Search your subject" class="form-control" aria-label="Text input with dropdown button" id="basic_search">
