...
<head>
    ...
    <title>Assignments | Academy</title>
        ...
        <section class="p-4 my-container nav-body">
            ...
            <div class="row m-2 my_div">
                <div class="col-12 pt-4">
                    <h2 class="text-center text-white">Assignments</h2>
                </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-6 m-auto mt-5">
                                    <div class="row">
                                        <div class="input-group mb-3">
                                            <input type="text" placeholder="Search students here..." class="form-control" aria-label="Text input with dropdown button" id="assignment_search">
                                ...
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            ...
                                            $Assignmentrs = Database::search("SELECT COUNT(`id`) AS `count` FROM `assignment`");
                                            $Assignment = $Assignmentrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Total Assignments :</span>
                                            <span class="text-white fs-4"> <?php echo $Assignment["count"]; ?> </span>
                                        </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 px-5 mt-3" style="overflow-x: auto">
                                    <table class="table table-bordered" style="width:100%">
                                        ...
                                        $view_assignment_rs = Database::search("SELECT * FROM `assignment` LIMIT " . $results_per_page . " OFFSET " . $page_first_result . " ");

                                        $view_results_num = $view_assignment_rs->num_rows;
                                        $c = 0;


                                        while ($assignment_data = $view_assignment_rs->fetch_assoc()) {
                                            $c = $c + 1;

                                            $subject_data = Database::search("SELECT * FROM `subject` WHERE `id`='" . $assignment_data["subject_id"] . "' ");
                                            $subject = $subject_data->fetch_assoc();
                                        ?>
                                            <tbody class="mt-1">
                                                <tr>
                                                    <th scope="row"><?php echo $assignment_data["id"]; ?></th>
                                                    <td><?php echo $assignment_data["name"]; ?></td>
                                                    <td><?php echo $subject["name"];  ?></td>
                                                    <td><?php echo $assignment_data["start_date"]; ?></td>
                                                    <td><?php echo $assignment_data["end_date"]; ?></td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                            </tbody>
                        ...
                        <div class="row mb-3 g-3 justify-content-center">
                            <div class="col-12 my_div1">
                                ...
                                <div class="row my-3">
                                    <div class="col-11 mx-auto">
                                        <div class="row">
                                            <button class="col-5 mx-auto py-2 btn-primary rounded rounded-3 text-center" onclick="addAssignmentWindow();">
                                                <span class="text-white fw-bold fs-4 bi bi-file-earmark-plus"></span>
                                                <span class="text-white fw-bold fs-4">Add Assignments</span>
                                            </button>
                ...
                <div class="modal" tabindex="-1" id="addAssignmentModal">
                    <div class="modal-dialog">
                        <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                            ...
                            <div class="modal-body text-center">
                                <div class="col-12">
                                    <h5 class="modal-title fs-5 fw-bold">Add Assignment</h5>
                                    <span class="text-danger" id="error-msg1"></span>
                                </div>

                                <div class="col-12">
                                    <input class="inputbox1 text-dark text-capitalize" type="text" placeholder="Assignment ID" id="assignment_id" />
                                </div>

                                <div class="col-12 gy-3">
                                    <input class="inputbox1 text-dark" type="text" placeholder="Assignment Name" id="assignment_name" />
                                </div>

                                <div class="col-12 gy-3">
                                    <input class="inputbox1 text-dark" type="datetime-local" placeholder="Start Date" id="start_date" />
                                </div>

                                <div class="col-12 gy-3">
                                    <input class="inputbox1 text-dark" type="datetime-local" placeholder="End Date" id="end_date" />
                                </div>

                                <div class="col-12 gy-3">
                                    <select class="inputbox1 text-dark" id="subject">
                                        <?php
                                ...
                                <div class="col-12 gy-3">
                                    ...
                                    <div class="col-6 mt-3 mx-auto">
                                        <button class="col-12 btn-orange" onclick="addNewAssignment();">Add Assignment</button>
                                    </div>
                                </div>
            ...
            <!-- success -->
            <div class="modal" tabindex="-1" id="newAssignmentCreatedModal">
                <div class="modal-dialog">
                    <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                        <div class="modal-header border-0">
                            <h5 class="modal-title fs-5 fw-bold">Success</h5>
                            <a href="assignments.php" class="btn-close"></a>
                        </div>
                        <div class="modal-body text-center">
                            <label class="success_message" style="height: 60px;"></label>
                            <br />
                            <label class="form-label fs-6">New assignment updated successfully.</label>
                        </div>
                        <div class="modal-footer border-0">
                            <a href="assignments.php" class="btn btn-secondary">Ok</a>
                        </div>
                    </div>
                </div>
            </div>
