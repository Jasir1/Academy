                            ...
                            <div class="row">
                                <div class="col-12 pt-3 pb-4 my_div1">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-8">
                                            <input class="inputbox_user col-10" type="text" placeholder="First Name" id="first_name" value="<?php echo $admin_data["first_name"] ?>" />
                                        </div>
                                    </div>
                                    <hr />
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-8">
                                            <input class="inputbox_user col-10" type="text" placeholder="Last Name" id="last_name" value="<?php echo $admin_data["last_name"] ?>" />
                                        </div>
                                    </div>
                                    <hr />
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-8">
                                            ...
                                            $gender_details = Database::search("SELECT * FROM `gender` WHERE `id`='" . $admin_data["gender_id"] . "'");
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                                                <div class="modal-header border-0">
                                                    <h5 class="modal-title fs-5">Profile Updated</h5>
                                    ...
                                    <div class="modal" tabindex="-1" id="updateProfileModal">
                                        <div class="modal-dialog">
                                            <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                                                ...
                                                <div class="modal-footer border-0">
                                                    <a href="adminProfile.php" class="btn btn-secondary" onclick="window.location.reload();">Close</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
