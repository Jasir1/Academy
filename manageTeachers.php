...
<body class="my_background1">
    ...
    ?>
        ...
        <nav class="navbar navbar-expand d-flex flex-column align-item-start shadow" id="sidebar">
            ...
            <script>
                var btn = document.getElementById('manageTeachers'); btn.style.backgroundColor = 'rgba(122, 118, 118, 0.5)';
            </script>
        ...
        <section class="p-4 my-container nav-body">
            ...
            <div class="row m-2 my_div">
                <div class="col-12 pt-4">
                    <h2 class="text-center text-white">Manage Teachers</h2>
                </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-6 m-auto mt-5">
                                    <div class="row">
                                        <div class="input-group mb-3">
                                            <input type="text" placeholder="Search teachers here..." class="form-control" aria-label="Text input with dropdown button" id="teacher_search">
                                ...
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            ...
                                            $ActiveUserrs = Database::search("SELECT COUNT(`status_id`) AS `count` FROM `teacher` WHERE `status_id`='1'");
                                            $ActiveUser = $ActiveUserrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Active Teachers :</span>
                                            <span class="text-white fs-4"> <?php echo $ActiveUser["count"]; ?> </span>
                                        </div>
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            <?php

                                            $InactiveUserrs = Database::search("SELECT COUNT(`status_id`) AS `count` FROM `teacher` WHERE `status_id`='2'");
                                            $InactiveUser = $InactiveUserrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Inactive Teachers :</span>
                                ...
                                ?>
                                    ...
                                    <div class="col-12 px-5 mt-2">
                                        <div class="row">
                                            ...
                                            $image_rs = Database::search("SELECT * FROM `teacher_profile_img` WHERE `user_email`='" . $user_data["email"] . "'");
                    ...
                    <div class="row mb-3 g-3 justify-content-center">
                        <div class="col-12 my_div1">
                            ...
                            <div class="row my-3">
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <button class="col-5 mx-auto py-2 btn-primary rounded rounded-3 text-center" onclick="addTeacherWindow();">
                                            <span class="text-white fw-bold fs-4 bi bi-person-plus-fill"></span>
                                            <span class="text-white fw-bold fs-4">Add Teachers</span>
                                        </button>
                ...
                <!-- add teacher modal -->
                <div class="modal" tabindex="-1" id="addTeacherModal">
                    <div class="modal-dialog">
                        <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                            ...
                            <div class="modal-body text-center">
                                <div class="col-12">
                                    <h5 class="modal-title fs-5 fw-bold">Add Teacher</h5>
                                ...
                                <div class="col-12 gy-3">
                                    ...
                                    <div class="col-6 mt-3 mx-auto">
                                        <button class="col-12 btn-orange" onclick="addNewTeacher();">Add Teacher & Send verification</button>
                                    </div>
                                </div>
            ...
            <!-- success -->
            <div class="modal" tabindex="-1" id="newTeacherAccountCreatedModal">
                <div class="modal-dialog">
                    <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                        <div class="modal-header border-0">
                            <h5 class="modal-title fs-5 fw-bold">Success</h5>
                            <a href="manageTeachers.php" class="btn-close"></a>
                        </div>
                        <div class="modal-body text-center">
                            <label class="success_message" style="height: 60px;"></label>
                            <br />
                            <label class="form-label fs-6">New teacher account created successfully.</label>
                        </div>
                        <div class="modal-footer border-0">
                            <a href="manageTeachers.php" class="btn btn-secondary">Ok</a>
                        </div>
                    </div>
                </div>
            </div>
