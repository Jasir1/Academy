...
<body class="my_background1">
    ...
    ?>
        ...
        <nav class="navbar navbar-expand d-flex flex-column align-item-start shadow" id="sidebar">
            ...
            <script>
                var btn = document.getElementById('purchasehistory'); btn.style.backgroundColor = 'rgba(122, 118, 118, 0.5)';
            </script>
                            ...
                            <div class="row mx-2 mt-3">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        $invoicers = Database::search("SELECT * FROM `invoice` WHERE `user_email`='" . $userEmail . "'");
                                        ...
                                        ?>
                                            ...
                                            <div class="col-12 col-lg-4 rounded border border-black-50 border-end text-center text-lg-end">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 d-grid">
                                                        <button class="btn btn-danger rounded border border-1 mt-3 fs-5 text-white">
