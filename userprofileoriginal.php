...
<body class="my_background1">
    ...
    ?>
        ...
        <nav class="navbar navbar-expand d-flex flex-column align-item-start shadow" id="sidebar">
            ...
            <script>
                var btn = document.getElementById('profile'); btn.style.backgroundColor = 'rgba(122, 118, 118, 0.5)';
            </script>
                                ...
                                <div class="col-12 mt-5" style="width: 135px;">
                                    ...
                                    <div class="align-items-center">
                                        ...
                                        ?>
                                            ...
                                            <img src="profile_images/avatar.png" class="avatar_img" id="prev" />
                                        <?php
                                        }
                            ...
                            <div class="row">
                                ...
                                <div class="modal" tabindex="-1" id="updateProfileModal">
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="background-color: rgba(0, 0, 0, .7); box-shadow: 0 15px 25px; border-radius: 10px;">
