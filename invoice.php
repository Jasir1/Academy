                                    ...
                                    <table class="table">
                                        ...
                                        <tbody class="my_div rounded-3 border border-end">
                                            <tr style="height: 72px;">
                                                ...
                                                <td class="fs-6 text-end border border-end pt-3 text-white">LKR. <?php echo $book_data["price"]; ?></td>
                                                <td class="fs-6 text-end border border-end pt-3 text-white"><?php echo $order_data["qty"]; ?></td>
                                                <td class="fs-6 text-end border border-end text-white">LKR. <?php echo $order_data["total"]; ?></td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-end">LKR. <?php echo $order_data["total"]; ?></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" class="border-0"></td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="fs-5 fw-bold text-end border-primary text-primary">LKR. <?php echo $order_data["total"] - $discount; ?></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
