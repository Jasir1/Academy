...
if (empty($username)) {
    ...
    $r = Database::search("SELECT * FROM `teacher` WHERE `email`='".$email."' OR `mobile`='".$mobile."' OR `username`='".$username."' ");
    $n = $r->num_rows;
    ...
    if ($n > 0){
        ...
        Database::iud("INSERT INTO `teacher` (`email`,`username`,`password`,`mobile`,`gender_id`,`register_date`)
