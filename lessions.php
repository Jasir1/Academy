...
<body class="my_background1">
    ...
    ?>
        ...
        <nav class="navbar navbar-expand d-flex flex-column align-item-start shadow" id="sidebar">
            ...
            <script>
                var btn = document.getElementById('lessions');
        ...
        <section class="p-4 my-container nav-body">
            ...
            <div class="row m-2 my_div">
                <div class="col-12 pt-4">
                    <h2 class="text-center text-white">Lessions</h2>
                </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-6 m-auto mt-5">
                                    <div class="row">
                                        <div class="input-group mb-3">
                                            <input type="text" placeholder="Search students here..." class="form-control" aria-label="Text input with dropdown button" id="lession_search">
                                ...
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            ...
                                            $Lessionrs = Database::search("SELECT COUNT(`id`) AS `count` FROM `lession`");
                                            $Lession = $Lessionrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Total Lession Notes :</span>
                                            <span class="text-white fs-4"> <?php echo $Lession["count"]; ?> </span>
                                        </div>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 px-5 mt-3" style="overflow-x: auto">
                                    <table class="table table-bordered" style="width:100%">
                                        ...
                                        $lession_rs = Database::search("SELECT * FROM `lession` ");
                                        $lession_num = $lession_rs->num_rows;

                                        $results_per_page = 10;
                                        $number_of_pages = ceil($lession_num / $results_per_page);

                                        $page_first_result = ((int)$page_no - 1) * $results_per_page;
                                        $view_lession_rs = Database::search("SELECT * FROM `lession` LIMIT " . $results_per_page . " OFFSET " . $page_first_result . " ");

                                        $view_results_num = $view_lession_rs->num_rows;
                                        $c = 0;


                                        while ($lession_data = $view_lession_rs->fetch_assoc()) {
                                            $c = $c + 1;

                                            $subject_data = Database::search("SELECT * FROM `subject` WHERE `id`='" . $lession_data["subject_id"] . "' ");
                                            $subject = $subject_data->fetch_assoc();
                                        ?>
                                            <tbody class="mt-1">
                                                <tr>
                                                    <th scope="row"><?php echo $lession_data["id"]; ?></th>
                                                    <td><?php echo $lession_data["name"]; ?></td>
                        ...
                        <div class="row mb-3 g-3 justify-content-center">
                            <div class="col-12 my_div1">
                                ...
                                <div class="row my-3">
                                    <div class="col-11 mx-auto">
                                        <div class="row">
                                            <button class="col-5 mx-auto py-2 btn-primary rounded rounded-3 text-center" onclick="addLessionWindow();">
                                                <span class="text-white fw-bold fs-4 bi bi-file-earmark-plus"></span>
                                                <span class="text-white fw-bold fs-4">Add Lession Notes</span>
                                            </button>
                ...
                ?>
                <!-- add Lession modal -->
                <div class="modal" tabindex="-1" id="addLessionModal">
                    <div class="modal-dialog">
                        <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                            ...
                            <div class="modal-body text-center">
                                <div class="col-12">
                                    <h5 class="modal-title fs-5 fw-bold">Add Lession</h5>
                                    <span class="text-danger" id="error-msg1"></span>
                                </div>

                                <div class="col-12">
                                    <input class="inputbox1 text-dark text-capitalize" type="text" placeholder="Lession ID" id="lession_id" />
                                </div>

                                <div class="col-12 gy-3">
                                    <input class="inputbox1 text-dark" type="text" placeholder="Lession Name" id="lession_name" />
                                </div>
                                ...
                                <div class="col-12 gy-3">
                                    ...
                                    <div class="col-6 mt-3 mx-auto">
                                        <button class="col-12 btn-orange" onclick="addNewLession();">Add Lession Notes</button>
                                    </div>
                                </div>
            ...
            <!-- success -->
            <div class="modal" tabindex="-1" id="newLessionCreatedModal">
                <div class="modal-dialog">
                    <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                        <div class="modal-header border-0">
                            <h5 class="modal-title fs-5 fw-bold">Success</h5>
                            <a href="lessions.php" class="btn-close"></a>
                        </div>
                        <div class="modal-body text-center">
                            <label class="success_message" style="height: 60px;"></label>
                            <br />
                            <label class="form-label fs-6">New lession notes updated successfully.</label>
                        </div>
                        <div class="modal-footer border-0">
                            <a href="lessions.php" class="btn btn-secondary">Ok</a>
                        </div>
                    </div>
                </div>
            </div>
