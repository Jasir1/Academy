...
<head>
    ...
    <title>User Profile | Academy</title>
...
<body class="my_background1">
    ...
    if (isset($_SESSION["student"]["email"]) | isset($_SESSION["teacher"]["email"]) | isset($_SESSION["academic_officer"]["email"])) {
                                    ...
                                    <div class="row mt-4 mb-4 justify-content-center">
                                        <div class="col-12 text-center">
                                            <div class="row">
                                                ...
                                                <?php
                                                if (isset($_SESSION["student"]["email"])) {
                                                    $user_details = Database::search("SELECT * FROM `student` WHERE `email`='" . $_SESSION["student"]["email"] . "'");
                                                    $user_data = $user_details->fetch_assoc();
                                                    $usermail = $_SESSION["student"]["email"];
                                                } else if (isset($_SESSION["teacher"]["email"])) {
                                                    $user_details = Database::search("SELECT * FROM `teacher` WHERE `email`='" . $_SESSION["teacher"]["email"] . "'");
                                                    $user_data = $user_details->fetch_assoc();
                                                    $usermail = $_SESSION["teacher"]["email"];
                                                } else if (isset($_SESSION["academic_officer"]["email"])) {
                                                    $user_details = Database::search("SELECT * FROM `academic_officer` WHERE `email`='" . $_SESSION["academic_officer"]["email"] . "'");
                                                    $user_data = $user_details->fetch_assoc();
                                                    $usermail = $_SESSION["academic_officer"]["email"];
                                                }
                                                ...
                                                <div class="col-8">
                                                    <input class="inputbox_user col-10" type="text" value="<?php echo $user_data["username"] ?>" id="username" />
                                                </div>
                                            </div>
                                            <hr />
                                            <div class="row mt-2">
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <input readonly class="inputbox_user col-10" type="text" value="<?php echo $user_data["register_date"]; ?>" />
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    $gender_details = Database::search("SELECT * FROM `gender` WHERE `id`='" . $user_data["gender_id"] . "'");
                            ...
                            <div class="row">
                                <div class="col-12 pt-3 pb-4 my_div1">
                                    ...
                                    <div class="row mt-3 justify-content-center">
                                        ...
                                        if (isset($_SESSION["student"]["email"])) {
                                            $address = Database::search("SELECT * FROM `student` WHERE `city_id` IS NOT NULL AND `email` = '" . $usermail . "'");
                                            $n = $address->num_rows;
                                        } else if (isset($_SESSION["teacher"]["email"])) {
                                            $address = Database::search("SELECT * FROM `teacher` WHERE `city_id` IS NOT NULL AND `email` = '" . $usermail . "'");
                                            $n = $address->num_rows;
                                        } else if (isset($_SESSION["academic_officer"]["email"])) {
                                            $address = Database::search("SELECT * FROM `academic_officer` WHERE `city_id` IS NOT NULL AND `email` = '" . $usermail . "'");
                                            $n = $address->num_rows;
                                        }
                                        if ($n > 0) {
                                        ...
                                        ?>
                                            <div class="col-8 mt-3">
                                                ...
                                                <input class="inputbox_user my_inputbox" type="text" placeholder="Address Line 01" id="address1" value="<?php echo $d["add_line1"] ?>" />
                                                <input class="inputbox_user" type="text" placeholder="Address Line 02" id="address2" value="<?php echo $d["add_line2"] ?>" />
                                            </div>
                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content my_div1" style="box-shadow: 0 15px 25px; border-radius: 10px;">
                                            <div class="modal-header border-0">
                                                <h5 class="modal-title text-white fs-5">Profile Updated</h5>
                                                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body text-center">
                                                <label id="modalStatus" style="height: 60px;"></label>
                                                <br />
                                                <label class="form-label fs-6 text-white" id="updateProfileModalMsg"></label>
                                            </div>
    ...
    <?php
    } else if (!isset($_SESSION["user"]["email"]) | !isset($_SESSION["teacher"]["email"]) | !isset($_SESSION["academic_officer"]["email"])) {
    ?>
